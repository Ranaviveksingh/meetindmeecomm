...
<body>  <header class="" id="km-header">
      ...
      <div class="km-navbar-brand text-lg-center">
        <div class="container">
          <button aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarTogglerDemo03" data-toggle="collapse" type="button"><i aria-hidden="true" ></i></button> <a class="navbar-brand" href="index.php"><img alt="koolmj" class="img-fluid" src="style/img/meetme.png"></a>
